        ...
        <div className={formStyle.innerContainer}>
          <Paper zDepth={0}>
            ...
            <div className={termsStyle.termsContainer}>
              <h1>UpRise Campaigns Terms of Use</h1>
              <p><h3> (Effective as of June 15, 2017)</h3></p>
              <p>Welcome to the UpRise service (the "Service").  The following Terms of Use apply when you view or use the Service (via our website located at Uprise.org). Please review the following terms carefully.  By accessing or using the Service, you signify your agreement to these Terms of Use.  If you do not agree to these Terms of Use, you may not access or use the Service.  </p>
              <h2>PRIVACY POLICY</h2>
              <p>The Company respects the privacy of its Service users.  Please refer to the Company's Privacy Policy (found here: [insert Link to Privacy Policy]), which explains how we collect, use, and disclose information that pertains to your privacy.  When you access or use the Service, you signify your agreement to this Privacy Policy. </p>
              <h2>ABOUT THE SERVICE</h2>
              <p>The Service allows you to search and sign up for volunteering activities and campaigns, create and manage campaigns, including communicating with participants and subscribers who have granted you permission to contact them. </p>
              <h2>LIMITATIONS ON USE OF PARTICIPANT AND SUBSCRIBER EMAIL ADDRESSES </h2>
              <p>As a user of the Service, you will gain access to the email addresses of users who have signed up for one of your volunteer actions or subscribed to your campaign. The participant or subscriber will have granted you LIMITED rights to use this address for the purpose of communicating about volunteer activities. You may not add this email address to your campaign email lists for any other purpose, including fundraising, without the users' expressed permission. You may ask the user to sign up for additional email by providing links to sign up forms in your communications. Violations of these terms will result in your loss of access to UpRise Services. </p>
              ...
              <ul><li>post any information that is abusive, threatening, obscene, defamatory, libelous, or racially, sexually, religiously, or otherwise objectionable and offensive;</li>
              ...
              <li>publish or link to malicious content intended to damage or disrupt another user's browser or computer. </li></ul>
              ...
              <li>You hereby affirm we have the right to determine whether any of your User Content submissions are appropriate and comply with these Terms of Service, remove any and/or all of your submissions, and terminate your account with or without prior notice. </li></ul>
              ...
              <p><h3> (a) Termination of Repeat Infringer Accounts. </h3>  The Company respects the intellectual property rights of others and requests that the users do the same.  Pursuant to 17 U.S.C. 512(i) of the United States Copyright Act, the Company has adopted and implemented a policy that provides for the termination in appropriate circumstances of users of the Service who are repeat infringers.  The Company may terminate access for participants or users who are found repeatedly to provide or post protected third party content without necessary rights and permissions. </p>
              <p><h3> (b) DMCA Take-Down Notices. </h3>  If you are a copyright owner or an agent thereof and believe, in good faith, that any materials provided on the Service infringe upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act (see 17 U.S.C 512) ("DMCA") by sending the following information in writing to the Company's designated copyright agent at </p>

              <p>UpRise Campaigns, SPC<br/>
              ...
              <li>Your name, address, telephone number, and email address, a statement that you consent to the jurisdiction of the federal court in New York and a statement that you will accept service of process from the person who provided notification of the alleged infringement. </li></ol>
              ...
              <p>We may also use your email address, to send you other messages, including information about the Company and special offers. You may opt out of such email by changing your account settings or sending an email to help@uprise.org or mail to the following postal address: </p>
              ...
              <p>If you have a dispute with one or more users, a restaurant or a merchant of a product or service that you review using the Service, you release us (and our officers, directors, agents, subsidiaries, joint ventures and employees) from claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, arising out of or in any way connected with such disputes.  If you are a California resident, you waive California Civil Code §1542, which says: "A general release does not extend to claims which the creditor does not know or suspect to exist in his favor at the time of executing the release, which if known by him must have materially affected his settlement with the debtor." </p>
