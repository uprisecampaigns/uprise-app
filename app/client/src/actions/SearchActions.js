...
export const ADD_DEFAULT_SEARCH_ITEM = 'ADD_DEFAULT_SEARCH_ITEM';
...
export const addDefaultSearchItem = (searchType, collectionName, value) => ({
  type: ADD_DEFAULT_SEARCH_ITEM, searchType, collection: collectionName, value,
});
